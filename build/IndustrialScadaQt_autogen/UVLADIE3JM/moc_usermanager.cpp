...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_UserManager_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_UserManager_t qt_meta_stringdata_UserManager = {
    {
        QT_MOC_LITERAL(0, 11),  // "UserManager"
...
Q_CONSTINIT static const uint qt_meta_data_UserManager[] = {
...
Q_CONSTINIT const QMetaObject UserManager::staticMetaObject = { {
    ...
    qt_meta_stringdata_UserManager.offsetsAndSizes,
    qt_meta_data_UserManager,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_UserManager_t,
        // Q_OBJECT / Q_GADGET
...
void UserManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &UserManager::authenticationChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void UserManager::authenticationChanged()
{
